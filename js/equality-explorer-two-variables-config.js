 ...
 * please modify equality-explorer-two-variables/package.json to control dependencies.
 *
 * RequireJS configuration file for the equality-explorer-two-variables sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'equality-explorer-two-variables-main' ],
