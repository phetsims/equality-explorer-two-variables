...
(3) Open `http://localhost/equality-explorer-two-variables/equality-explorer-two-variables_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
